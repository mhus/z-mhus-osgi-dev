...
public class CmdDevCxf extends AbstractCmd {
    ...
    @Option(
            name = "--max",
            description = "Max Loops for fire",
            required = false,
            multiValued = false)
    int max = 30;
    ...
    public Object execute2() throws Exception {
        ...
        if (cmd.equals("runtime")) {
            for (org.osgi.service.jaxrs.runtime.JaxrsServiceRuntime runtime :
                    MOsgi.getServices(
                            org.osgi.service.jaxrs.runtime.JaxrsServiceRuntime.class, null)) {
        ...
        if (cmd.equals("Extension")) {
        ...
        } else if (cmd.equals("BookingService")) {
            if (bookingServiceRegistration == null) {
                ...
                bookingServiceRegistration =
                        context.registerService(
                                BookingService.class, new SecondBookingServiceRest(), properties);
            } else {
