...
public final class Strings {
     ...
     * the other direction," converting empty strings to {@code null}, you can use {@link
     * #emptyToNull}.
     *
    ...
    /**
     * True when a valid surrogate pair starts at the given {@code index} in the given {@code
     * string}. Out-of-range indexes return false.
     */
    @VisibleForTesting
     ...
     * counts do not match, returns a best-effort form of that string. Will not throw an exception
     ...
     * where {@code String.format} is not available. As an example, method implementations of the
    ...
    public static String lenientFormat(
            @NullableDecl String template, @NullableDecl Object... args) {
