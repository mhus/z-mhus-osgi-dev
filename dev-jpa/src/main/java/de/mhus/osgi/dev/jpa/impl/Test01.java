...
public class Test01 {
    ...
    public static EntityManager createEntityManager(String provMatch) {
        ...
        if (provMatch == null) provMatch = ".*hiber.*";
        ...
        for (PersistenceProvider pp : MOsgi.getServices(PersistenceProvider.class, null)) {
            ...
            if (pp.toString().matches(provMatch)) persistenceProvider = pp;
        }
        ...
        EntityManagerFactory entityManagerFactory =
                persistenceProvider.createContainerEntityManagerFactory(info, createMap);
