...
import de.mhus.osgi.dev.cache.ehcache.jsr107.internal.spi.loadwriter.DefaultCacheLoaderWriterProvider;
...
public class Eh107CacheLoaderWriterProvider extends DefaultCacheLoaderWriterProvider {
    ...
    public <K, V> CacheLoaderWriter<? super K, V> createCacheLoaderWriter(
            String alias, org.ehcache.config.CacheConfiguration<K, V> cacheConfiguration) {
