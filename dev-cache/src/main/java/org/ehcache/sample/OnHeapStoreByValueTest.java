...
public class OnHeapStoreByValueTest {
    ...
    private void testComplexValues() {
        ...
        final Cache<String, TestContainer> cache =
                cacheManager.createCache(
                        "cache1",
                        CacheConfigurationBuilder.newCacheConfigurationBuilder(
                                        String.class, TestContainer.class, heap(2))
    ...
    public void testStoreByValue() {
        ...
        final Cache<Long, String> cache1 =
                cacheManager.createCache(
                        "cache1",
                        CacheConfigurationBuilder.newCacheConfigurationBuilder(
                                        Long.class, String.class, heap(1))
                                .build());
    ...
    private void performTest(Cache<Long, String> cache, boolean same) {
        ...
        if ((s1 == s2) != same) System.out.println("s1, s2: Failed");
        if ((s2 == s3) != same) System.out.println("s2, s3: Failed");
    }
}
